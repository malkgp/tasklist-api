package br.com.okfx.tasklist.api.cors;
...
public class CorsFilter implements Filter {
    ...
    @Autowired
    private TaskListApiProperty apiProperty;
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        res.setHeader("Access-Control-Allow-Credentials", "true"); // Permite o envio do cookie de refresh_token
